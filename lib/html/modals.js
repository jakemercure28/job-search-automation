...
<div class="modal-overlay" id="auto-apply-attempt-modal">
  <div class="modal" style="max-width:760px">
    <h2 id="auto-apply-attempt-title">Auto-Apply Receipt</h2>
    <div class="modal-sub" id="auto-apply-attempt-sub"></div>
    <div id="auto-apply-attempt-body" style="white-space:pre-wrap;font-size:13px;line-height:1.6;max-height:60vh;overflow-y:auto;margin-top:12px;padding:12px;background:var(--bg-card);border:1px solid var(--border);border-radius:6px;color:var(--text-primary)">Loading…</div>
    <div class="modal-actions">
      <button class="btn" style="background:var(--slate);color:var(--text-muted)" onclick="closeAutoApplyAttempt()">Close</button>
    </div>
  </div>
</div>`;
}
