...
- Prefer writing things down before building them
- Comfortable operating across the backend/platform boundary
- Want peer review and a functioning design-review culture, not solo heroics
- Will say "I don't know" before I'll bullshit an answer
...
Full detail lives in `profiles/example/context.md` and `profiles/example/career-detail.md`. When working on applications or outreach in this applicant's voice, always read those first.
